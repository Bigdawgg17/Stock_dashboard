...
indicators = st.sidebar.multiselect('Techincal Indicators', ['SMA 20', 'EMA 20'])
...
st.sidebar.info('This dashboard provides stock data and techincal indicators for various time periods.')
